                    ...
                    <h3>Enter Payment Details</h3>
                       <input name="id" type="hidden" value="<?php echo $_GET['u']; ?>">
                        <div class="form-group row" style="padding: 5px 15px;padding-left: 0px;padding-right: 0px;">
                          ...
                          <div class="col-sm-9">
                           <select id="payment_method" name="payment_method" required="required" class="form-control"><option value="" selected="selected">Select Payment Method</option><option value="Bitcoin Wallet">Bitcoin Wallet</option><option value="Bank Transfer">Bank Transfer</option><option value="Bank Deposit">Bank Deposit</option></select>
                          </div>
                        </div>
